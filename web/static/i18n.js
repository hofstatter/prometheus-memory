...
(function(){
  const T = {
    ...
    'sessão(ões) ativa(s) agora': {en:'active session(s) now', es:'sesión(es) activa(s) ahora', zh:'当前活动会话'},
    'Backlog': {en:'Backlog', es:'Pendientes', zh:'待办'},
    'Em andamento': {en:'In progress', es:'En curso', zh:'进行中'},
    'Concluído': {en:'Done', es:'Completado', zh:'已完成'},
    'BLOQUEADO': {en:'BLOCKED', es:'BLOQUEADO', zh:'阻塞'},
    'vazio': {en:'empty', es:'vacío', zh:'空'},
    'Sem eventos ainda': {en:'No events yet', es:'Aún no hay eventos', zh:'暂无事件'},
    'Kanban': {en:'Kanban', es:'Kanban', zh:'看板'},
    'Timeline': {en:'Timeline', es:'Cronología', zh:'时间线'},
    'Detalhes do evento': {en:'Event details', es:'Detalles del evento', zh:'事件详情'},
    'Memória canônica': {en:'Canonical memory', es:'Memoria canónica', zh:'规范记忆'},
